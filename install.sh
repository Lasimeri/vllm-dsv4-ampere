...
echo "  VLLM_SM86_PREFILL_LOOP=1      force old per-token MLA prefill loop (vectorized ON by default; 6.9-10.2x TTFT)"
echo "  (K11 default OFF; K12 + K13 + vectorized prefill default ON; see README for tradeoffs)"
