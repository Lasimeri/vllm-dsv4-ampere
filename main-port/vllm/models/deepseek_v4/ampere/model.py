...
from vllm.models.deepseek_v4.ampere.ampere_sparse import DeepseekV4AmpereAttention
...
class DeepseekV4MegaMoEExperts(nn.Module):
    ...
    def _check_runtime_supported(self) -> None:
        raise NotImplementedError("DeepSeek V4 MegaMoE is not supported on Ampere.")
